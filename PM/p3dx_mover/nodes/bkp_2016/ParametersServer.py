class staticParameters:
    ...
    #mensagens de Status
    status_msg = ["Status: seeking", "Status: avoiding collision", "Status: circumnavegating", "Status: circumnavegating and avoiding collision"]
